...
alias cdsh="cd /Users/charlieporto/realshit/shellscripts"
alias downloads="open /Users/charlieporto/Downloads"
...
alias fbf="firebase emulators:start --only functions"
alias fenotes="vim /Users/charlieporto/realshit/telematics/meeting_notes/daily_notes/frontend_documentation.txt"
alias devchrome="/Users/charlieporto/realshit/shellscripts/webdev/./open_webdev_chrome.sh"
...
# c++ stuff
alias comp='compcpp sim_runner.cpp main.o -sdl'
alias compt='compcpp playground.cpp main.o'
...
compcpp () {		#(comp_file, make_file, tag)
	...
	comp_command="g++ ${comp_file} -std=c++17 -o ${make_file}"
	if [[ $tag ]]
	then
	if [[ "$tag" == "-sdl" ]]
	then
...
rmf()
{
	...
	rmf_key_map=(
		...
		# run vlab
		"/Users/charlieporto/realshit/telematics/code/python_projs/science/vue_science/vuelab" "npm run serve"
...
touchvue () {
	touch $1;
	filename="$(basename ${1} .vue)"
	echo "<script>" >> $1
	echo "export default {" >> $1
	echo "	name: '${filename}'," >> $1
	echo " " >> $1
	echo "}" >> $1
	echo " " >> $1
	echo "</script>" >> $1
...
cdgo () {
	...
	cdl_key_map=(
		...
		"vb" "/Users/charlieporto/realshit/telematics/code/python_projs/chapter2/vimbus/vue_nimbus"
		"vlab" "/Users/charlieporto/realshit/telematics/code/python_projs/science/vue_science/vuelab"
		# cpp
